...
\section{Summary and Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Expertise:}{ Advanced process control, process simulation, plantwide control, process operability analysis, artificial intelligence - AI (supervised machine learning), nonlinear constrained optimization (NLP)} \\ \vspace{3pt}
