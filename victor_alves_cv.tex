...
\begin{center}
    ...
    $|$
    \faGlobe \hspace{.5pt} \href{https://victor-alves.com}{\color{blue}victor-alves.com}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/victoraalves}{\color{blue}@victoraalves}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/victor-alves-cheme/}{\color{blue}victor-alves-cheme}
...
\section{Summary and Skills}
  ...
  I am a Ph.D. candidate in chemical engineering at West Virginia University and a member of \href{https://fernandolima.faculty.wvu.edu/}{\color{black}CODES research group}. My expertise encompasses Process Systems Engineering (PSE), where I have developed advanced algorithms for process modeling, control, and nonlinear constrained optimization. Additionally, I possess expertise in supervised machine learning techniques applied to industrial applications. My background is further enriched by hands-on industry experience in the oil and gas, petrochemical, and energy sectors.
  \resumeSubHeadingListStart
    \small{\item{

        \textbf{Expertise:}{ Advanced process control, process simulation, plantwide control, process operability analysis, supervised machine learning, nonlinear constrained optimization (NLP)} \\ 

        \textbf{Programming:}{ Python, MATLAB, markdown, restructuredText, LaTeX and exposure to R} \\ 
        
        \textbf{Technologies:}{ Git, GitHub, Simulink} \\ 

        \textbf{Process simulation:}{ Aspen Plus, Aspen Plus Dynamics, Aspen Custom Modeler, HYSYS, AVEVA Process Simulation, PRO/II, Dynsim} \\ 
        \textbf{Languages:}{ English and Portuguese}

        \textbf{Clifton Strengths:}{ Achiever | Context | Learner | Intellection | Focus}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {M.Sc., Chemical Engineering;}{Sept. 2017 \textbf{--} March 2020}{\textbf{Academic Coefficient: 10.00/10.00}}{}
