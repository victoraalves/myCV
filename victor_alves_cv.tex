  ...
  {Postdoctoral Fellow (Ph.D.)}{May 2024 \textbf{--} Currently}
    ...
    \resumeSubheading
      ...
      {Graduate Research Assistant (Ph.D.)}{Aug 2020 \textbf{--} May 2024}
        \resumeItemListStart
            \resumeItem{Working with Dr. Fernando V. Lima on the development of emerging techniques for process operability calculations, involving mainly supervised machine-learning, constrained nonlinear programming (NLP) and automatic differentiation (AD) for efficient algorithm development.}
