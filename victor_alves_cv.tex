...
%----------- RELEVANT COURSEWORK AND TEACHING -----------
...
\section{Skills}
  ...
  % I am a Ph.D. candidate in chemical engineering at West Virginia University and a member of \href{https://fernandolima.faculty.wvu.edu/}{\color{blue}CODES research group}. My expertise encompasses Process Systems Engineering (PSE), where I have developed advanced algorithms for process modeling, control, and nonlinear constrained optimization and supervised machine learning techniques applied to industrial applications. My background is further enriched by hands-on industry experience in the oil and gas, petrochemical, and energy sectors.
  \resumeSubHeadingListStart
    \small{\item{
